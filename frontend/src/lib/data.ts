...
export const users = {
  PI: { name: "Dr. Arjun Sharma", email: "arjun.sharma@university.edu", dept: "Biotechnology", role: "PI" as Role },
  FINANCE: { name: "Rohit Mehta", email: "rohit.mehta@university.edu", dept: "Accounts", role: "FINANCE" as Role },
  ADMIN: { name: "Dr. Meera Iyer", email: "meera.iyer@university.edu", dept: "Research Office", role: "ADMIN" as Role },
  AUDITOR: { name: "S.K. Verma", email: "sk.verma@university.edu", dept: "Internal Audit", role: "AUDITOR" as Role },
};
